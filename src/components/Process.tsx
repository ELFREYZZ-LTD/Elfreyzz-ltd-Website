...
export const Process = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="reveal py-12 sm:py-16 lg:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3">Our Process — Simple, clear, deliverable</h2>
        <p className="text-muted-foreground text-base sm:text-lg mb-8 sm:mb-12 max-w-3xl">
